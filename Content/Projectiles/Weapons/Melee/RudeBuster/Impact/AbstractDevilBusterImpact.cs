...
namespace Delterra.Content.Projectiles.Weapons.Melee.RudeBuster.Impact {
    ...
    // Yes, this is mostly a copy-paste of the homing example. Cry about it.
    public abstract class AbstractDevilBusterImpact : ModProjectile {
        ...
        public override void AI() {
            ...
            Projectile.velocity = Projectile.velocity.ToRotation().AngleTowards(targetAngle, MathHelper.ToRadians(3)).ToRotationVector2() * HomingVelocity;
            Projectile.rotation = Projectile.velocity.ToRotation();
        }
